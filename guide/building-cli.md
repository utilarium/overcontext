...
```typescript
import { createCLIBuilder, discoverOvercontext } from '@theunwalked/overcontext';
...
import { discoverOvercontext, createCLIBuilder } from '@theunwalked/overcontext';
...
```typescript
import { formatEntities, formatEntity } from '@theunwalked/overcontext';
